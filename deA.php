				 ...
				 //   echo "<br> 100 m MALE <br>";
				    while($row = mysqli_fetch_assoc($result)) {
				      $rrn = $row["roll"];
				    	...
				    	echo "<td>" . $sno++. "</td>"."<td> <input type = \"radio\" name = \"seldel\" value = $rrn> </td>"."<td>" . $row["name"] . "</td>" . "<td>". $row["roll"] . "</td>" . "<td>". $row["batch"] . "</td>";
				    	echo "</tr>";
...
$result = mysqli_query($conn, $sql_m101);
	...
	<table class="table table-striped table-bordered table-hover">e-hover">
