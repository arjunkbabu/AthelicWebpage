...
/*	$stud_reg_query = "INSERT INTO `athletics`.`STUDENT` 
   ...
   */
        $stud_reg_query = "INSERT INTO `athletics`.`cricket` (`TEAM`,`Roll_no`, `Gender`, `Batch`, `contact`, `Capt_name`, `Play1`, `Play2`, `Play3`, `Play4`) VALUES ('$v_team', '$v_roll', '$v_gender', '$v_batch', '$v_phone', '$v_name', '$v_p1', '$v_p2', '$v_p3', '$v_p4')";
