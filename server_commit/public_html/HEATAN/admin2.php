...
WHERE  `event_id` = 101) AND `STUDENT`.`CHEST` IN ( SELECT  `Heats_100M`.`chest` FROM  `Heats_100M` 
WHERE  `team` = 1)  order by `STUDENT`.`batch`";
...
FROM  `STUDENT` WHERE  `STUDENT`.`roll` IN ( SELECT  `REGISTRATION`.`roll` FROM  `REGISTRATION` 
WHERE  `event_id` = 101) AND `STUDENT`.`CHEST` IN ( SELECT  `Heats_100M`.`chest` FROM  `Heats_100M` 
WHERE  `team` = 2)  order by `STUDENT`.`batch`";
...
FROM  `STUDENT` WHERE  `STUDENT`.`roll` IN ( SELECT  `REGISTRATION`.`roll` FROM  `REGISTRATION` 
WHERE  `event_id` = 101) AND `STUDENT`.`CHEST` IN ( SELECT  `Heats_100M`.`chest` FROM  `Heats_100M` 
WHERE  `team` = 3)  order by `STUDENT`.`batch`";
...
FROM  `STUDENT` WHERE  `STUDENT`.`roll` IN ( SELECT  `REGISTRATION`.`roll` FROM  `REGISTRATION` 
WHERE  `event_id` = 101) AND `STUDENT`.`CHEST` IN ( SELECT  `Heats_100M`.`chest` FROM  `Heats_100M` 
WHERE  `team` = 4)  order by `STUDENT`.`batch`";
...
FROM  `STUDENT` WHERE  `STUDENT`.`roll` IN ( SELECT  `REGISTRATION`.`roll` FROM  `REGISTRATION` 
WHERE  `event_id` = 101) AND `STUDENT`.`CHEST` IN ( SELECT  `Heats_100M`.`chest` FROM  `Heats_100M` 
WHERE  `team` = 5)  order by `STUDENT`.`batch`";
...
FROM  `STUDENT` WHERE  `STUDENT`.`roll` IN ( SELECT  `REGISTRATION`.`roll` FROM  `REGISTRATION` 
WHERE  `event_id` = 101) AND `STUDENT`.`CHEST` IN ( SELECT  `Heats_100M`.`chest` FROM  `Heats_100M` 
WHERE  `team` = 6)  order by `STUDENT`.`batch`";
...
FROM  `STUDENT` WHERE  `STUDENT`.`roll` IN ( SELECT  `REGISTRATION`.`roll` FROM  `REGISTRATION` 
WHERE  `event_id` = 101) AND `STUDENT`.`CHEST` IN ( SELECT  `Heats_100M`.`chest` FROM  `Heats_100M` 
WHERE  `team` = 7)  order by `STUDENT`.`batch`";
...
FROM  `STUDENT` WHERE  `STUDENT`.`roll` IN ( SELECT  `REGISTRATION`.`roll` FROM  `REGISTRATION` 
WHERE  `event_id` = 101) AND `STUDENT`.`CHEST` IN ( SELECT  `Heats_100M`.`chest` FROM  `Heats_100M` 
WHERE  `team` = 8)  order by `STUDENT`.`batch`";
...
FROM  `STUDENT` WHERE  `STUDENT`.`roll` IN ( SELECT  `REGISTRATION`.`roll` FROM  `REGISTRATION` 
WHERE  `event_id` = 101) AND `STUDENT`.`CHEST` IN ( SELECT  `Heats_100M`.`chest` FROM  `Heats_100M` 
WHERE  `team` = 9)  order by `STUDENT`.`batch`";
...
FROM  `STUDENT` WHERE  `STUDENT`.`roll` IN ( SELECT  `REGISTRATION`.`roll` FROM  `REGISTRATION` 
WHERE  `event_id` = 101) AND `STUDENT`.`CHEST` IN ( SELECT  `Heats_100M`.`chest` FROM  `Heats_100M` 
WHERE  `team` = 10)  order by `STUDENT`.`batch`";
...
FROM  `STUDENT` WHERE  `STUDENT`.`roll` IN ( SELECT  `REGISTRATION`.`roll` FROM  `REGISTRATION` 
WHERE  `event_id` = 101) AND `STUDENT`.`CHEST` IN ( SELECT  `Heats_100M`.`chest` FROM  `Heats_100M` 
WHERE  `team` = 11)  order by `STUDENT`.`batch`";
